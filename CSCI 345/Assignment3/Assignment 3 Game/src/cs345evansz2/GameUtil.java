...
public class GameUtil {
	...
	public static int shorterLength(String word1, String word2){
	...
	public static boolean isPrefixMatch(String prefixWord, String fullWord){
		...
		for (int i = 1; i < shorterLength(prefixWord, fullWord) + 1; i++){
			if(!prefixWord.substring(0, i).equals(fullWord.substring(0, i)) ){
				return false;	
			}
		}
		return true;	
